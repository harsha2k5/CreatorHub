<?php
/**
 * CreatorHub - Profile & Compatibility Helper Service
 */
...
if (!function_exists('getOrCreateCreatorProfile')) {
...
if (!function_exists('calculateHaversineDistance')) {
    /**
     * Calculate spherical distance between two points in kilometers
     */
