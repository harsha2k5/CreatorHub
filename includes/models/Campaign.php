    ...
    public static function create(array $data): ?array {
        ...
        Database::execute(
            "INSERT INTO campaigns (
                id, brand_id, title, description, category, min_followers,
                budget_total, reward_per_creator, creators_required, location_name,
            ...
            [
                ...
                $data['min_followers'] ?? ($data['target_followers_min'] ?? 0),
                $data['budget_total'] ?? 0,
                $data['reward_per_creator'] ?? 0,
                $data['creators_required'] ?? ($data['max_creators'] ?? 1),
                $data['location_name'] ?? ($data['location_target'] ?? 'Bengaluru'),
