...
export const Navbar: React.FC = () => {
  ...
  return (
    <header className="sticky top-0 z-50 bg-[#09090b]/90 backdrop-blur-md border-b border-zinc-800 transition-colors">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        {/* Logo */}
        <Link to="/" className="flex items-center gap-2.5 group">
          <div className="w-9 h-9 rounded-xl bg-zinc-900 border border-zinc-700/80 flex items-center justify-center text-white shadow-sm group-hover:border-zinc-500 transition-colors">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          {user ? (
            ...
            <div className="flex items-center gap-2">
              <Link
                to="/creator/login"
                className="px-4 py-2 text-xs font-semibold text-zinc-300 hover:text-white rounded-xl hover:bg-zinc-900 transition-colors"
              >
                Login
              </Link>
              <Link
                to="/choose-role"
                className="px-4 py-2 text-xs font-semibold text-zinc-950 rounded-xl bg-white hover:bg-zinc-200 shadow-sm transition-all"
              >
                Get Started
              </Link>
            </div>
